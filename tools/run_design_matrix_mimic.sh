...
# A 基础架构（不包含创新点）
python train_mimic.py --k-bits-list 32,64,128 --epochs 80 --batch-size 128 --use-amp true --amp-dtype bf16 \
